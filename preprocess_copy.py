...
def main():
    ...
    sfile = codecs.open(SOURCE_PATH, 'r')
    tfile = codecs.open(TARGET_PATH, 'r')
    outf = codecs.open(NEW_TARGET_PATH, 'w', buffering=1)
    outf_tgt_src = codecs.open(PRED_SRC_PATH, 'w', buffering=1)
    outf_tgt_tgt = codecs.open(PRED_TGT_PATH, 'w', buffering=1)
